...
def main():
    ...
    raw_url = "https://web.archive.org/web/20251228214217id_/https://vocaloid-fantasia.com/cir-iciran04.htm"
    ...
    for table in tables:
        ...
        for row in table_rows[1:]:  # Skip header row
                ...
                if not position:
                    ...
                    continue
                if position.startswith("A") or position.startswith("Ａ"):
                    print("Skipping koetuki circle (A position):", row)
                    continue
                ...
                if web_tag and web_tag.has_attr("href"):
                    new_url = web_tag["href"].replace("https://web.archive.org/web/20251228214217/", "")
