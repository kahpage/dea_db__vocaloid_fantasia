...
def main():
    ...
    raw_url = "https://web.archive.org/web/20160307085202id_/http://vocaloid-fantasia.com/cir-iciran05.htm"
    ...
    for table in tables:
        ...
        for row in table_rows[1:]:  # Skip header row
                ...
                if web_tag and web_tag.has_attr("href"):
                    new_url = web_tag["href"].replace("https://web.archive.org/web/20160307085202/", "")
